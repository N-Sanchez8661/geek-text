...
CREATE TABLE `comment` (
  ...
  CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rating` (
  ...
  CONSTRAINT `rating_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`)
...
-- Dump completed on 2025-03-21 17:38:45
